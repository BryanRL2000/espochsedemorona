...
export const speakers: Speaker[] = [
  ...
  {
    id: 20,
    name: "Eloísa Jacqueline Altamirano Vaca",
    photo: "/ELOISA.png",
    title: "Doctora en Humanidades y Artes - Mención Ciencias de la Educación",
    institution: "Universidad Central del Ecuador",
    country: "Ecuador",
    countryCode: "EC",
    day: "2026-06-03",
    time: "16:00 – 17:00",
    topic: "Morona Santiago y la Universidad del Futuro: Pertinencia Académica para el Desarrollo Territorial",
    modality: "Presencial",
    expertise: ["Educación superior", "Diseño curricular", "Gestión educativa", "Política pública educativa"],
    bio: "Doctora (PhD.) en Educación por la Universidad Nacional de Rosario (Argentina), con múltiples maestrías en Educación, Diseño y Gestión de Proyectos Socioeducativos, Liderazgo Educativo y Dirección de Centros Educativos. Docente Titular en la Universidad Central del Ecuador desde hace 17 años. Ha sido Facilitadora Externa del Consejo de Educación Superior y Evaluadora Externa del CACES. Profesora invitada en posgrados de varias universidades del país. Autora de una veintena de publicaciones académicas indexadas. Experiencia en educación en línea, diseño curricular, evaluación y gestión educativa.",
  },
  {
    id: 21,
    name: "Jonathan Wladimir Orbe Terán",
    photo: "/JONATHAN.png",
    title: "Licenciado en Ciencias de la Educación, mención Informática Aplicada",
    institution: "Universidad Central del Ecuador / Universidad de Investigación e Innovación de México",
    country: "Ecuador",
    countryCode: "EC",
    day: "2026-06-03",
    time: "17:00 – 18:00",
    topic: "Pertinencia de la educación superior en la Amazonía",
    modality: "Presencial",
    expertise: ["Educación superior", "Diseño curricular", "Gestión académica", "Educación inclusiva"],
    bio: "Licenciado en Ciencias de la Educación por la UCE y Magíster en Docencia Universitaria por la ESPE. Cursando doctorado en Educación e Innovación en México. Experiencia en gestión académica, diseño curricular y evaluación de educación superior. Ha desempeñado cargos estratégicos en la Universidad de Guayaquil y el Consejo de Educación Superior. Asesor y Experto Académico en proyectos de creación de universidades e institutos tecnológicos. Coordinó procesos nacionales de capacitación docente en educación inclusiva dirigidos a más de 5,000 docentes del sistema de educación superior ecuatoriano.",
  },
